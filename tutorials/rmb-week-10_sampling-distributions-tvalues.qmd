...
- We can treat postive and negative t-values the same in a two tailed test. A t-value of +1.3 and -1.3 will have the same p-value.
...
| 5 | One-Tailed | `r fitb(0.001)` |
| 2.5 | Two-Tailed | `r fitb(0.05)` |
| -1.4 | One-Tailed | `r fitb(0.085)` |
| -0.5 | Two-Tailed | `r fitb(0.191)` |

## Hint

Carefull read the key points from the bullet points above about converting values. Talk with your tutor if you get stuck.
