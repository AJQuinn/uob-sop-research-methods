...
3. In the Linear Regression tab *Model fit* tick R, R^2^, adjusted R^2^ and F test. Under *Model Coefficients* click confidence interval and standardised estimate. 
...
1. What was the original correlation? `r fitb(.388)`

2. What is the value of β~0~? (3 d.p.) `r fitb(69.684)` and  β~1~? `r fitb(0.626)`

3. Write down the regression equation (state coefficients to 1dp): y = `r fitb(69.7)` + `r fitb(0.6)`x

4. What is the value of *R^2^*? (as a proportion, 3 d.p.) `r fitb(0.150)`

5. What is *R^2^~adj~*? (as a proportion, 3 d.p.) `r fitb(0.142)`

6. What is the predicted value of stress for the 10th individual on the data sheet based on this regression equation? (using the equation, round answer to 1dp) `r fitb(98.3)`
