...
A guide to installing Jamovi on your personal computer can be found [here](../support/frequently-asked-questions.qmd) 
...
## Setting up data files and entering data {.unnumbered}
...
### Understanding the data - visual inspection of the data 
...
## 3. Crosstabs: looking at frequencies in combinations of groups {.unnumbered}
...
## 4. Exploring the data {.unnumbered}
...
## 5. Using Jamovi to prepare/transform data for analysis 
...
### Compute variable - calculate total scores for several related variables {.unnumbered}
...
## 6. Calculate mean scores for several related variables {.unnumbered}
### Activity 6
...
## 7. Calculate a difference between 2 scores from the same participant (change from baseline) {.unnumbered}
### Activity 7
...
## 8. Recode into different variables to create categories from a continuous variable {.unnumbered}
