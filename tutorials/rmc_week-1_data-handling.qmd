...
What is the grouping (between-subjects) variable and how many times is it measured?
...
## <i class="bi bi-question-lg"></i> Q1 - How many participants and how many variables were there?
...
::: {.callout-caution icon="false" collapse="true"}
## <i class="bi bi-question-lg"></i> Q2 - Are there any missing data or any odd-looking cells?
...
::: {.callout-caution icon="false" collapse="true"}
## <i class="bi bi-question-lg"></i> Q3 - Give an example (identify the example by the Jamovi row number)
...
::: {.callout-caution icon="false" collapse="true"}
## <i class="bi bi-question-lg"></i> Q4 - What did you notice about these rows of data? Describe it in a few words. 
...
175 cases were processed as there were 177 participants but 2 had missing data.
:::
::::
...
The most common outcome was 'yes' and this accounted for 84.6% of the data 
:::
::::
...
Psychology without biology A-level
:::
::::
...
Based on the histograms the data isn't normally distributed 
:::
::::
...
Yes there is an outlier in row 98 
:::
::::
...
No - the data look quite similar in both the boxplots and box plots 
:::
::::
...
Psychology A-level yes: 37.5

Psychology A-level no: 34.4
:::
::::
...
Males had a higher total score (mean males = 18.3; mean females = 17.7)
:::
::::
...
Using the skills from the 'Understanding the data' section, which participant(s) have the second highest mean scores?
...
Yes it looks like there is a difference in how bloodsugar changes between the two different drinks 
:::
::::
...
Group 1 drank glucose and their blood sugar level increased 
:::
::::
...
Group 2 drank saccharin and their blood sugar level decreased 
:::
::::
