...
## 1. How to perform a chi-square in Jamovi {.unnumbered}
...
## 2. How to report these results in APA format {.unnumbered}
...
A Pearson Chi-Square was used to identify whether `r mcq(c(answer = "gender", "smoking", "exercise"))` influenced `r mcq(c("obestiy", answer = "smoking", "exercise"))` frequency. Results of the chi-square `r mcq(c(answer = "showed a significant difference", "did not show a signficant difference"))` in smoking frequency between genders (*χ²* (`r fitb(1)`) = `r fitb(21.9)`, *p* `r mcq(c(" = .652", answer = "< .001", "= .036"))`.
...
As the results were `r mcq(c(answer = "statistically significant", "not significant"))`, there `r mcq(c(answer = "is an", "is no"))` association between `r mcq(c("obestiy", answer = "smoking", "exercise"))` frequency and `r mcq(c(answer = "gender", "smoking", "exercise"))`, with `r mcq(c(answer = "males", "females"))` being more likely to be a smoker than `r mcq(c("males", answer = "females"))`. 

:::
::::

## 4. Exercise 2 {.unnumbered}
...
A Pearson Chi-Square was used to identify whether there was an association between gender and whether or not you play football. Results of the chi-square `r mcq(c("showed a significant association", answer = "did not show a signficant association"))` between gender and whether or not you play football (*χ²* (`r fitb(1)`) = `r fitb(2.71)`, *p* `r mcq(c(" < .001", answer = "= .100", "= .076"))`.
...
The results mean that there is `r mcq(c(answer = "no significant association", "a signficant association"))` between gender and whether or not you play football. Men are `r mcq(c("significantly", answer = "not signficantly"))` more likely to play football than women. 
