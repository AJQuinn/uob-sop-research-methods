...
Welcome to this practical session! This week you will be introduced to Jamovi. You will use Jamovi throughout your degree for statistical analysis, so it is very important to get familiar with it! 
...
Each row represents `r mcq(c(answer = 'one participants data', 'one variable', 'a level of a variable'))`.

Each column represents `r mcq(c('one participants data', answer = 'one variable', 'a level of a variable'))`.
...
There are `r fitb(8)` variables in the dataset. 
...
Gender: `r mcq(c('ordinal', 'scale (continuous)', answer='nominal', 'ID'))`.

Bdate: `r mcq(c('ordinal', 'scale (continuous)', 'nominal', answer='ID'))`.

Educ: `r mcq(c('ordinal', 'scale (continuous)', answer='nominal', 'ID'))`.

Jobcat: `r mcq(c('ordinal', 'scale (continuous)', answer ='nominal', 'ID'))`.

Salary: `r mcq(c('ordinal', answer='scale (continuous)', 'nominal', 'ID'))`.

Salbegin: `r mcq(c('ordinal', answer = 'scale (continuous)', 'nominal', 'ID'))`.

Prevexp: `r mcq(c('ordinal', answer = 'scale (continuous)', 'nominal', 'ID'))`.

Minority: `r mcq(c('ordinal', 'scale (continuous)', answer = 'nominal', 'ID'))`.
...
Bdate: `r mcq(c('ordinal', 'scale (continuous)', answer ='nominal'))`.
...
## 6. Descriptive statistics exercises {.unnumbered}
...
Mean education men: `r fitb(12.4)`.

Mean education women: `r fitb(14.4)`.
...
Group 1: `r fitb(27839)`.

Group 2: `r fitb(30939)`.

Group 3: `r fitb(63978)`.
...
## 7. How to save your work in Jamovi {.unnumbered}
