...
|     | Measures of dispersion and spread (Standard Deviation & Interquartile Range)                                   |
...
I can save you some time! The -2 year old is on row 2165 and the 149 year old is on row 2997 (or 2996 if you've already deleted the youngster...). Take care to make sure you have the right row before modifying the dataset.

Note, that this will not change the file - just the version of the data loaded into Jamovi. If you make a mistake you can simply load the original file and start again.
