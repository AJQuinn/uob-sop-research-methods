...
We can define our own variables in Jamovi using the 'Transform' function in the 'Variables' or the 'Data' tabs. Open a new Transformed variable.
...
The statistical test allows us to reject the null hypothesis that participant performance was no different to chance level on this task.
...
Does the conclusion match your expectations?
...
Open the 'Independent Sample t-test' menu under 't-tests'. To run the analysis, drag `AIConfidenceBefore` across as our dependent variable and our new `ConfidentBefore` variable as the grouping variable. The results should appear on the right automatically.
...
We can see this by looking at the means in the descriptive statistics and the descriptives plot if you run this.
...
## 8. Bonus Hypothesis! People are more accurate at identifying photos of real people compared to AI generated photos.
