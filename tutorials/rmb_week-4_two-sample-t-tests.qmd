...
Confidence in indentifying people you used to know in primary school from strangers  `r mcq(c('decreased', answer = 'increased'))` from `r fitb(3.63)` before to `r fitb(3.51)` afterwards.
