...
|  |  |  |
|--------------|----------------------|-----------------------------------|
| =========== | Data Skills :========================================================= Working with the Jamovi editor |  |
|  |  |  |
|  | Performing a correlation in Jamovi |  |
|  | Produce graphs in Jamovi |  |
...
If the data do not lead us to reject the null hypothesis, the interpretation is more problematic – do we “accept” the null, or “retain” it, or just withhold judgement”? • We can definitely never claim to have “proved” the null hypothesis (as you cannot 100% prove a null statement)! A non-significant result is an inconclusive one – we have insufficient data to choose which hypothesis (null or alternative) is the most accurate.
...
There are **five** variables in the dataset \* Age \* Ice_Cream - number of ice creams sold \* Temp - temperature \* Motivation \* Stress
