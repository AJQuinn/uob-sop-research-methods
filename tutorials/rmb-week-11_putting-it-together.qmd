...
This is a bit annoying but straightforward to fix. Create a new Transformed variable from `hp_condition` by computing `1 - hp_condition`. 

**Note : Make sure you use 'Transform' and not 'Compute' for your variable. 'Compute' will not retain the right data type.**

We covered transforming variables in [Week 7 Section 7](rmb_week-7_non-parametrics.html#transforming-non-normally-distributed-data).
...
| ------- | ----- | ----- | ----- | ----- |
| Powerful | `r mcq(c("Confirmed", answer="Violated"))` | `r mcq(c(answer = "Confirmed", "Violated"))` | `r mcq(c("Student's t", "Welch's t", answer = "Mann-Whitney U"))` |
| Testosterone | `r mcq(c("Confirmed", answer="Violated"))` | `r mcq(c("Confirmed", answer = "Violated"))` | `r mcq(c("Student's t", "Welch's t", answer = "Mann-Whitney U"))` |
| Cortisol | `r mcq(c("Confirmed", answer="Violated"))` | `r mcq(c("Confirmed", answer = "Violated"))` |`r mcq(c("Student's t", "Welch's t", answer = "Mann-Whitney U"))` |
| Risk Taking (Gain) | `r mcq(c("Confirmed", answer="Violated"))`  | `r mcq(c("Confirmed", answer = "Violated"))` | `r mcq(c("Student's t", "Welch's t", answer = "Mann-Whitney U"))` |
...
| Variable | Normality | Homogeneity of Variance | Preferred Test |
| ------- | ----- | ----- | ----- | ----- |
| Powerful | Violated | Confirmed | Mann-Whitney U |
| Testosterone | Violated  | Violated | Mann-Whitney U |
| Cortisol | Violated  | Violated | Mann-Whitney U |
| Risk Taking (Gain) | Violated  | Violated | Mann-Whitney U |
